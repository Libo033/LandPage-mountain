...
const Footer = () => {
  return (
    <footer className="pb-20 px-8 bg-[#0b1d26] flex flex-col md:flex-row md:gap-6">
      <div className="md:w-1/2 md:min-h-full md:flex md:flex-col md:justify-between">
        <div>
          <p
            style={lora.style}
          ...
          <p className="w-[290px] pb-8 text-white text-pretty font-medium md:w-[240px]">
      ...
      <div className="mt-16 md:mt-0 md:w-1/2">
        ...
        <p className="text-white mt-6 cursor-pointer">Contributors & Writers</p>
